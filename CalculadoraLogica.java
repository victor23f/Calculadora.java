	...
	public static void menuAritmetico() {
		...
		do {
			...
			try {
				...
				case 4:
					System.out.println("La division es igual a: " + dividir() + "\n");
					break;
				case 5:

					break;
				default:
					System.err.println("Tienes que introducir un numero entre 1 y 5 \n"); // control de error en caso de
																							// que introduzca un numero
																							// que no este entre 1 y 5
					break;

				}

			} catch (NumberFormatException e) {
				System.err.println("No se permiten letras \n");// Solo se permiten numeros de entrada

			} catch (Exception e) {
				System.err.println("Error de entrada y salida"); //control de errores para operaciones indeterminadas
			}
		} while (opcion != 5);
	}
		...
		try {
			...
			do {
				...
				if (numero1 != 0 && numero1 != 1) {
					System.err.println("Debes de introducir operadores logicos válidos");
				}
			...
			System.err.println("Debes introducir un numero, vuelve a elegir la opcion");
		} catch (Exception e) {
